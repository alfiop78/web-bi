...
class MyVerticaGrammar extends Grammar
{
    /**
    ...
    public function compileTableExists()
    {
        ...
        // return "SELECT * FROM v_catalog.all_tables WHERE TABLE_NAME = ? AND SCHEMA_NAME = ?";
        return "SELECT * FROM v_catalog.all_tables WHERE SCHEMA_NAME = ? AND TABLE_NAME = ?";
    }
    ...
    public function compileColumnListing()
    {
        ...
        // return 'select column_name from columns where table_schema = \'decisyon_cache\' and table_name = ?'; // da verificare
        return 'select column_name from columns where table_name = ?';
    }
